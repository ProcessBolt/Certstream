    ...
    public class CertstreamClient
    {
        ...
        public event EventHandler<LeafCertificate> CertificateIssued
        {
            add
            {
                ...
                if (ConnectionType != ConnectionType.Full) throw new ApplicationException("Only available in connection type: Full.");
        ...
        public event EventHandler<string> HostnameSpotted
        {
            add
            {
                ...
                if (ConnectionType != ConnectionType.DomainsOnly) throw new ApplicationException("Only available in connection type: Domains-Only.");
