...
namespace Certstream
{
    internal class Constants
    {
        ...
        /// <summary>
        /// The buffer size for holding incoming messages. - <b>16 KiB</b>
        /// </summary>
        public const int BufferSize = 16384;
        /// <summary>
        /// An array used to hold ping bytes that are sent periodically to the server to keep the connection alive.
        /// </summary>
        public static readonly ArraySegment<byte> PingBytes = new ArraySegment<byte>(Encoding.UTF8.GetBytes("ping"));
        /// <summary>
